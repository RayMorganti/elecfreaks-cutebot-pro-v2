...
try:  # Start a try block for basic error handling.
    robot.set_headlights(LightSelector.LEFT, 255, 0, 0)  # Turn on both headlights and set them to green.
    sleep(10)  # Keep both headlights green for 10 seconds.
    robot.set_headlights(LightSelector.LEFT, 0, 0, 0)  # Turn off all headlights.
