# elecfreaks_cutebot_pro_v2

A modified MicroPython module for the Elecfreaks Cutebot Pro v2 on the BBC micro:bit.  The module provides new functionality for Cutebot Pro v2, removes support for Cutebot Pro v1 and makes additional changes for added clarity and consistency. 
...
See [`docs/changes_from_original.md`](docs/changes_from_original.md) for a summary of major changes.
